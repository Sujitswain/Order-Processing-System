package com.sujit.inventory_service.client;
...
public class OrderServiceClient {
    ...
    public OrderResponse getOrder(UUID orderId) {
        try {
            ...
            throw new InventoryInternalServerException(HttpStatus.SERVICE_UNAVAILABLE, "Unable to fetch order details from Order Service", ex);
        }
    }
}
